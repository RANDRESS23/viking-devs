    ...
    <footer className="relative w-full flex flex-col pt-20 pb-10 font-inter-sans">
      ...
      <div className="flex flex-col items-center relative z-10">
        <h2 className="heading lg:max-w-[47vw]">
          ¿Listo para llevar tu negocio al <span className='text-[#ff5500] font-extrabold italic'>siguiente nivel</span> ?
        </h2>
        ...
        <Link href="https://wa.me/message/JE3JHGELREIUP1" target="_blank" rel="noopener noreferrer" className='md:mt-5'>
          <button className="flex justify-center w-72 mt-5 items-center gap-2 px-4 py-3 rounded-md border border-[#171717] bg-[#ff5500] text-white hover:scale-95 shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200 font-semibold text-sm">
            Agendar una reunión
